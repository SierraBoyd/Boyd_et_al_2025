---
title: "General Activity Concentration-Response Modeling"
author: Sierra Boyd
output:
  html_document:
    theme: cerulean
...
file.dir <- paste("~", sep="")
file.name <- paste0("/ActivityScan_tcplfit2_curves", Sys.Date(), ".pdf", sep="")
...
for(i in 1:nrow(res)){
  concRespPlot(res[i,],ymin=-100,ymax=100) 
}
...
MetricNames<-c("Inter-Spike Interval (ms)","Active Area","Spike Amplitude (µm)","Firing Rate (Hz)")
...
Activity_AC50_Updated<-pheatmap(potency_matrix,
        ...
        color=pal,
        breaks=breaks,
        display_numbers=display_matrix,number_color="white",fontsize_number=11)
