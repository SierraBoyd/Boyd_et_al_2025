...
```{r}
write.csv(AllMetrics_melt,file = "C:/Users/sboyd01/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Project-Chronic DNT Organoid/Data Analysis/Network Analysis/Exported Files/Network_scan_Melt.csv")
```
