---
title: "Neural Network Concentration-Response Modeling"
author: Sierra Boyd
output:
  html_document:
    theme: cerulean
...
file.dir <- paste("~", Sys.Date(), ".pdf", sep="")
...
MetricNames<-c("Burst Frequency (Counts/min)",
               "Burst Peak (Hz)",
               "Cluster Frequency (Counts/min)",
               "Number of Burst per Cluster",
               "Cluster Duration (ms)",
               "Inter-Burst-Interval (ms)",
               "Inter-Cluster-Interval (ms)",
               "Number of Spikes per Burst",
                "Burst Duration (ms)")

colnames(heatmap_wide)<-MetricNames

#Set up annotation column for Cluster vs Bursts
Group<-c("Burst","Burst","Cluster","Burst","Cluster","Burst","Cluster","Burst","Burst")
annotated_df<-data.frame(Group=Group)
rownames(annotated_df)<-MetricNames
ann_colors<-list(Group=c(Cluster="dodgerblue4",Burst="springgreen4"))
...
Network_AC50_Updated<-pheatmap(potency_matrix,
        cluster_rows=F,
        cluster_cols=T,
        color=pal,
        breaks=breaks,
        display_numbers=display_matrix, number_color="white",fontsize_number=9,
        annotation_col=annotated_df,
        annotation_colors = ann_colors,
        annotation_names_col=FALSE)
  
ggsave("Network_AC50_Updated.png",plot=Network_AC50_Updated,bg="white",width=6,height=5.5)
