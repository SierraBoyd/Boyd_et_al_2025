...
#load csv files
for (i in csv_files){
  Activity_Scan<-fread(i)
  Activity_Scan<-Activity_Scan[,-1]
}
...
#Export
write.csv(Activity_CV_Median_Mad,file = "~")
...
#Export
write.csv(Network_Median_MADs,file = "~")
...
#Export
write.csv(Axon_CV_Median_Mad,file = "~")
